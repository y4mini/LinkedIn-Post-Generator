...
def extract_metadata(post):
    ...
    1. Return a valid JSON. Np preamble.
    2. JSON object should have exactly three keys: line_count, language and tags.
    3. tags is an array of text. Extract maximum two tags.
    4. Language should be English or Hinglish(which means hindi + english)
